...
public class Forest extends ActivityGroup {
    int wood_counter, leaves_counter, stone_counter, w,l,s, stone_axeb, stone_pickb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final  int stone_axeb = stone1_axe.getInt("stone_axe", 0);
        final  int stone_pickb = stone1_pick.getInt("stone_pick", 0);
